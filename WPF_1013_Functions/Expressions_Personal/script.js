...
(costCloths >= moneytoSpend || costCloths >= myBank)?(console.log('You have enough cash to buy your Cloths!')):(console.log('Sorry, but you do not have enough cash to buy your items. You currenty have', moneytospend, ' and ', myCredit, ' On your debit card.'));
